...
# Exibir o texto e a imagem na mesma linha
st.markdown(f"# FIFA OFFICIAL DATASET! <img src='https://img.icons8.com/?size=100&id=xsj5Zlx99Bjv&format=png&color=000000' width='50'>", unsafe_allow_html=True)
st.sidebar.markdown("Desenvolvido por [ Rogério Ferreira] (www.linkedin.com/in/rogeriomf)")
